package com.example.mad_practical5_22012011075.screen
...
import com.example.mad_practical5_22012011075.R
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                FormRowField(labelString = "Confirm Password", isPasswordField =
                true)
                Spacer(modifier = Modifier.height(20.dp))
                // Register button
                Button(
    ...
    Row(
        ...
        OutlinedTextField(
            ...
            modifier = Modifier
                .weight(2f)
                .padding(start = 16.dp),
            keyboardOptions = if (isNumber) KeyboardOptions(keyboardType =
            KeyboardType.Phone) else
